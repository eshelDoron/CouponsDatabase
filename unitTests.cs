        ...
        public void add()
        {
            using (var db1 = new CouponsDatabase())
            {
                ...
                try
                {
                    ...
                    {
                    Assert.AreEqual("yuval", item.userName);
                    } 
                    //buisnessOwner
                    ...
                    {
                        Assert.AreEqual("eshel", item.userName);
                    } 
                    ...
                    {
                        Assert.AreEqual("raz", item.userName);
                    } 
                    //locationAlert
                    ...
                    {
                        Assert.AreEqual("it is near", item.subject);
                    } 
                    Assert.IsNotNull(la.user.First());
                    ...
                    {
                        Assert.AreEqual("expires soon", item.subject);
                    ...
                    {
                        Assert.AreEqual("a sports coupon", item.subject);
                    ...
                    {
                        Assert.AreEqual("user used coupon once", item.subject);
                    } 
                    ...
                    {
                        Assert.AreEqual("business issued coupon", item.subject);
                    } 
                    ...
                    {
                        Assert.AreEqual("business rate is good", item.subject);
                    } 
                    ...
                    {
                        Assert.AreEqual("caldo", item.businessName);
                    } Assert.IsNotNull(bs.buisCouponReport.First());
                    ...
                    {
                        Assert.AreEqual("food", item.categoryName);
                    } Assert.IsNotNull(cat.business.First());
                    ...
                    {
                        Assert.AreEqual("123", item.serialKey);
                    } Assert.IsNotNull(ord.business);
                    ...
                    {
                        Assert.AreEqual("free pizza", item.name);
                    } Assert.IsNotNull(cou.manager);
